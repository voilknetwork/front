...
class PostsIndex extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={
          "PostsIndex row" + (fetching ? " fetching" : "") + layoutClass
        }
      >
        ...
        <aside className="c-sidebar c-sidebar--right">
          ...
          !this.props.username ? (
            ...
            this.props.isBrowser && (
              <div>
                {/* <SidebarStats voilkPower={123} followers={23} reputation={62} />  */}
        ...
        <aside className="c-sidebar c-sidebar--left">
          ...
          />
          <small>
            <a className="c-sidebar__more-link" onClick={this.onShowSpam}>
              {showSpam
