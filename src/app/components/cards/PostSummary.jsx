...
class PostSummary extends React.Component {
  ...
  render() {
    ...
    if (reblogged_by) {
      reblogged_by = (
        <div className="articles__revoilk">
          <p className="articles__revoilk-text">
            <span className="articles__revoilk-icon">
              <Icon name="reblog" />
            </span>
            <UserNames names={reblogged_by} /> {tt("postsummary_jsx.revoilked")}
          </p>
        </div>
      );
    }
    ...
    const full_power = content.get("percent_voilk_dollars") === 0;
    ...
    const bIllegalContentUser = userIllegalContent.includes(
      content.get("author")
    );

    if (bIllegalContentUser) {
      title_text = "Black Listed Post";
      desc = "This blog was black listed, violation of Terms and Service.. ";
      return null;
    }
        ...
        return (
          ...
          >
            <div className="PostSummary__nsfw-warning">
              {summary_header}
              <span className="nsfw-flag">nsfw</span>&nbsp;&nbsp;<span
                className="ptc"
                role="button"
              ...
              {username ? (
                ...
                <span>
                  <a href={SIGNUP_URL}>
                    {tt("postsummary_jsx.create_an_account")}
                  </a>{" "}
    ...
    if (!gray && p.image_link && !userBlacklisted) {
      ...
      if (this.props.blogmode) {
        ...
        const listSize = proxifyImageUrl(p.image_link, "256x512").replace(
          / /g,
          "%20"
        );
