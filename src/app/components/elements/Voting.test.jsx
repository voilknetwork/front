...
const mockGlobal = Map({
    ...
    content: Map({
        test: Map({
            ...
            max_accepted_payout: '999999 VSD',
            percent_voilk_dollars: 0,
            pending_payout_value: '10 VSD',
            cashout_time: '2018-03-30T10:00:00Z',
            pending_payout_vsd: 99,
        }),
    }),
});
...
describe('Voting', () => {
    ...
    it('should show all SP if percent_voilk_dollars is 0', () => {
    ...
    it('should omit liquid voilk if print rate is 10000', () => {
        const store = createStore(rootReducer);
        const post_obj = fromJS({
            stats: {
                total_votes: 1,
    ...
    it('should show liquid voilk if print rate is < 10000', () => {
        const post_obj = fromJS({
            stats: {
                total_votes: 1,
            },
