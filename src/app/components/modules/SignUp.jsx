...
class SignUp extends React.Component {
    ...
    render() {
        ...
        if (this.props.serverBusy || $SHR_Config.disable_signups) {
            return (
                <div className="row">
                    <div
                    ...
                    >
                        <p>
                            Membership to Voilk.com is now under invitation
            ...
            <div className="SignUp">
                <div className="row">
                    <div className="column">
                        <h3>Sign Up</h3>
                        <p>
                            Voilknetwork funds each account with over{' '}
                            {this.props.signup_bonus} worth of Voilk Power; to
                ...
                <div className="row">
                    <div className="column">
                        ...
                        <p className="secondary">
                            By verifying your account you agree to the Voilknetwork{' '}
