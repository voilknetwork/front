...
export function sortComments(cont, comments, sort_order) {
    ...
    const sort_orders = {
        ...
        trending: (a, b) => {
            ...
            // If VSD payouts were equal, fall back to rshares sorting
...
class CommentImpl extends React.Component {
    ...
    render() {
        ...
        const bIllegalContentUser = userIllegalContent.includes(comment.author);

        if (bIllegalContentUser)
        {
            comment.body = "Illegal Content";
            return null;
        }
        ...
        // const voilk_supply = this.props.global.getIn(['props','current_supply']);
