...
class UserWallet extends React.Component {
    constructor() {
        ...
        this.onShowDepositVoilk = e => {
            ...
            new_window.location =
                'https://blocktrades.us/?input_coin_type=eth&output_coin_type=voilk&receive_address=' +
                name;
        };
        this.onShowWithdrawVoilk = e => {
            ...
            new_window.opener = null;
            new_window.location =
                'https://blocktrades.us/unregistered_trade/voilk/eth';
        };
        this.onShowDepositPower = (current_user_name, e) => {
            ...
            new_window.opener = null;
            new_window.location =
                'https://blocktrades.us/?input_coin_type=eth&output_coin_type=voilk_power&receive_address=' +
                current_user_name;
        };
        this.onShowDepositVSD = (current_user_name, e) => {
            ...
            new_window.opener = null;
            new_window.location =
                'https://blocktrades.us/?input_coin_type=eth&output_coin_type=vsd&receive_address=' +
                current_user_name;
        };
        this.onShowWithdrawVSD = e => {
            ...
            new_window.opener = null;
            new_window.location =
                'https://blocktrades.us/unregistered_trade/vsd/eth';
        };
    ...
    render() {
        ...
        if (savings_withdraws) {
            savings_withdraws.forEach(withdraw => {
                ...
                if (asset === 'VOILK') savings_pending += parseFloat(amount);
                    ...
                    if (asset === 'VSD')
                        savings_vsd_pending += parseFloat(amount);
                }
            });
        }
        ...
        const dicoining =
            parseFloat(account.get('coining_withdraw_rate').split(' ')[0]) >
            0.0;
        const vsd_balance = parseFloat(account.get('vsd_balance'));
        const vsd_balance_savings = parseFloat(
            savings_vsd_balance.split(' ')[0]
        );
        const vsdOrders =
        ...
        if (isMyAccount) {
            voilk_menu.push({
                value: tt('g.buy'),
                link: '#',
                onClick: onShowDepositVoilk.bind(
                    this,
        ...
        const voilk_orders_balance_str = numberWithCommas(
            voilkOrders.toFixed(3)
        );
        ...
        const vsd_orders_balance_str = numberWithCommas(
            '$' + vsdOrders.toFixed(3)
        );
                    ...
                    </div>
                    {
                        <div className="columns shrink">
                            {isMyAccount && (
                                ...
                                >
                                    {tt(
                                        'userwallet_jsx.buy_voilk_or_voilk_power'
                                    )}
                                </button>
                            )}
                        </div>
                    ...
                    <div className="column small-12 medium-8">
                        ...
                        {delegated_voilk != 0 ? (
                            <span className="secondary">
                                {tt(
                                    'tips_js.part_of_your_voilk_power_is_currently_delegated',
