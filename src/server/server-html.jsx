    ...
    return (
        <html lang="en">
            <head>
                ...
                />
                <meta name="propeller" content="45bcbdc08aed18e2478150696af32d78" />
                {meta &&
                    meta.map(m => {
                        if (m.title) {
                            page_title = m.title;
                ...
                <link
                    ...
                    sizes="128x128"
                />
                <meta name="application-name" content="Voilknetwork" />
                ...
                <script data-ad-client="ca-pub-2334057890514402" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
