...
class PickAccount extends React.Component {
    ...
    render() {
        ...
        //         <div className="column">
        //             <div className="callout alert">
        //                 <p>Our records indicate that you already have voilk account: <strong>{existingUserAccount}</strong></p>
        //                 <p>In order to prevent abuse Voilknetwork can only register one account per verified user.</p>
        //                 <p>You can either <a href="/login.html">login</a> to your existing account
        //                     or <a href="mailto:support@voilk.com">send us email</a> if you need a new account.</p>
        //             </div>
        //         </div>
        //     </div>;
        // }
