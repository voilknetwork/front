...
import { PrivateKey } from 'voilk/lib/auth/ecc';
...
class CreateAccount extends React.Component {
    ...
    render() {
        ...
        if (serverBusy || $SHR_Config.disable_signups) {
            return (
                <div className="row">
                    <div className="column">
                        <br />
                        <div className="callout alert">
                            <p>
                                Membership to Voilk.com is now under
                ...
                <div className="row">
                    <div className="column">
                        ...
                        <div className="callout alert">
                            ...
                            <p>
                                We will be unable to create your Voilk account
                                with this browser.
                            </p>
                            <p>
                ...
                <div className="row">
                    <div className="column">
                        ...
                        <div className="callout alert">
                            ...
                            <p>
                                Please note that Voilknetwork can only register one
                    ...
                    <div className="column">
                        ...
                        <div className="callout alert">
                            <p>
                                ...
                                <a href="mailto:support@voilk.com">
                                    support@voilk.com
                                </a>{' '}
        ...
        return (
            <div>
                <div className="CreateAccount row">
                    <div className="column">
                        <h4>
                            Please read the Voilknetwork Rules and fill in the form
                            below to create your Voilknetwork account
                        </h4>
                        {showRules ? (
                            <div className="CreateAccount__rules">
                                <p>
                                    The first rule of Voilknetwork is: Do not lose
                                    your password.<br />
                                    The second rule of Voilknetwork is: Do{' '}
                                    <strong>not</strong> lose your password.<br
                                    />
                                    The third rule of Voilknetwork is: We cannot
                                    ...
                                    without knowing the password. Voilknetwork is a
