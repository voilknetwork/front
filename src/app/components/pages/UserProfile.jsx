...
export default class UserProfile extends React.Component {
  ...
  shouldComponentUpdate(np, ns) {
    ...
    return (
      ...
      ns.showRevoilk !== this.state.showRevoilk
    );
  }
  ...
  loadMore(last_post, category, showRevoilk) {
  ...
  toggleShowRevoilk = e => {
    e.preventDefault();
    const newShowRevoilk = !this.state.showRevoilk;
    this.setState({ showRevoilk: newShowRevoilk });
  };

  render() {
    const {
      state: { showRevoilk },
      props: { current_user, wifShown, global_status, follow, accountname },
      onPrint
    } = this;
    ...
    if (section === "transfers") {
      ...
      tab_content = (
        <div>
          <UserWallet
            ...
            withdrawCoining={this.props.withdrawCoining}
          />
        </div>
      );
      ...
      if (account.blog) {
        ...
        if (!fetching && (posts && !posts.size)) {
          ...
          tab_content = (
            <div>
              <a href="#" onClick={this.toggleShowRevoilk}>
                {showRevoilk
                  ? tt("user_profile.hide_revoilks")
