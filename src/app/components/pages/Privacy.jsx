        ...
        return (
            <div className="Privacy row">
                <div className="column large-12">
                    <h1>Voilknetwork, Inc Privacy Policy</h1>
                    ...
                    <p className="c2">
                        <span>
                            This Privacy Policy describes how Voilknetwork collects,
                            uses and discloses information, and what choices you
                            have with respect to the information. This Policy
                            applies to the
                        </span>
                        <span>
                            &nbsp;Voilk.com, voilknetwork subdomains (e.g.,
                            signup.voilk.com) and services
                        </span>
                        <span className="c1">
                    ...
                    <p className="c2">
                        <span className="c1">
                            When we refer to &ldquo;Voilknetwork&rdquo;, we mean the
                            Voilknetwork entity that acts as the controller of your
                            information.
                        </span>
                    </p>
                    <p className="c2">
                    ...
                    <p className="c2">
                        <span className="c1">
                            ...
                            incoinigate, and deter against fraudulent,
                    ...
                    <p className="c2">
                        <span className="c1">
                            ...
                            any incoinigation, enforce our Terms of Service, and
                    ...
                    <p className="c2">
                        <span>
                            ...
                            request to privacy@voilk.com. You can request to
                        ...
                        <span className="c8 c12">
                            <a
                                className="c5"
                                href="https://www.google.com/url?q=https://github.com/voilknetwork/conveyor%23get_user_data-username&amp;sa=D&amp;ust=1527292847102000"
                            >
                                here
                            </a>
                        </span>
                    ...
                    <p className="c2">
                        <span className="c1">
                            ...
                            contacting us at privacy@voilk.com
                        </span>
                    </p>
                    <p className="c0">
                        <span className="c1" />
                    ...
                    <p className="c2">
                        <span>
                            ...
                            privacy@voilk.com. We may request specific
                            ...
                            privacy@voilk.com or submit a complaint to the
