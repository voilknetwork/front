...
export const APP_NAME = 'Voilknetwork';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'Voilknetwork';
export const APP_NAME_UPPERCASE = 'VOILKNETWORK';
export const APP_ICON = 'voilk';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $SHR_Config, server should read config package.
export const APP_URL = 'https://fast.voilk.com';
export const APP_DOMAIN = 'fast.voilk.com';
export const LIQUID_TOKEN = 'Voilk';
// sometimes it's impossible to use html tags to style coin name, hence usage of _UPPERCASE modifier
export const LIQUID_TOKEN_UPPERCASE = 'VOILK';
export const COINING_TOKEN = 'SHARE POWER';
export const INCOIN_TOKEN_UPPERCASE = 'SHARE POWER';
export const INCOIN_TOKEN_SHORT = 'SP';
