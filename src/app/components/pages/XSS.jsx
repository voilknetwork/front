...
></SCRIPT>">'><SCRIPT>alert(String.fromCharCode(88,83,83))</SCRIPT>`,
    ...
    `<SCRIPT SRC=https://voilkd.com/xss.js></SCRIPT>`,

    `onnerr w/ clearly invalid img: <img src="awesome.jpg" onerror="alert('xss')" /><br />
good image: <img src="https://voilk.io/images/press/press-theblkchn.png" onerror="alert('xss')" /><br />
good url, bad img: <img src="https://voilk.io/testing-does-not-exist.png" onerror="alert('xss')" /> 
