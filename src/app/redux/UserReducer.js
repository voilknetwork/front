...
export default function reducer(state = defaultState, action) {
    ...
    switch (action.type) {
        ...
        case SET_USER:
            if (payload.coining_shares)
                payload.coining_shares = parseFloat(payload.coining_shares);
            if (payload.delegated_coining_shares)
                payload.delegated_coining_shares = parseFloat(
                    payload.delegated_coining_shares
                );
            if (payload.received_coining_shares)
                payload.received_coining_shares = parseFloat(
                    payload.received_coining_shares
                );
