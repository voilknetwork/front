...
const SortOrder = ({ topic, sortOrder, horizontal, pathname }) => {
    ...
    return horizontal ? (
        <ul className="nav__block-list">
           ...
           <li className="nav__block-list-item"><a href="https://invest.voilk.com" target="_blank">Invest</a></li>
           <li className="nav__block-list-item"><a href="https://ads.voilk.com" target="_blank">Advertise</a></li>
        </ul>
    ) : (
        <NativeSelect
