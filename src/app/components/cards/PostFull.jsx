...
class PostFull extends React.Component {
    ...
    render() {
        ...
        const full_power = post_content.get('percent_voilk_dollars') === 0;
                    ...
                    <span>
                        ...
                        <div className="PostFull__body entry-content">
                            <ImpRecorder 
                                ...
                                lockTimeout={600}
                                adtype={"mediam"}   // 在一个导致frame切换动作发生后禁止组件外观更新的时间
                            />
                            {contentBody}
                            <ImpRecorder 
                                classPref="ads-rotator" // class前缀，所有class均基于该值计算
                ...
                <div className="PostFull__footer row">
                    ...
                    <div className="RightShare__Menu small-11 medium-12 large-5 columns">
                        ...
                        <span className="PostFull__views">
                            <PageViewsCounter
                                hidden={false}
                                sinceDate={isPreViewCount ? 'Jan 2019' : null}
                            />
                        </span>
