...
import { getStateAsync } from 'app/utils/voilkApi';
...
export async function serverRender(
    ...
    try {
        ...
        return {
            title: 'Routing error - Voilknetwork',
            statusCode: 500,
            body: renderToString(
    ...
    if (error || !renderProps) {
        ...
        return {
            title: 'Page Not Found - Voilknetwork',
            statusCode: 404,
    ...
    try {
        ...
        if (
            ...
            return {
                title: 'User Not Found - Voilknetwork',
                statusCode: 404,
                body: renderToString(<NotFound />),
            };
        }
        ...
        if (!url.match(routeRegex.Post)) {
            for (var key in onchain.content) {
                //onchain.content[key]['body'] = onchain.content[key]['body'].substring(0, 1024) // TODO: can be removed. will be handled by voilkd
        ...
        if (location.match(routeRegex.UserProfile1)) {
            ...
            return {
                title: 'Server error - Voilknetwork',
                statusCode: 500,
