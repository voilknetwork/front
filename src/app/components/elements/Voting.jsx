...
class Voting extends React.Component {
  ...
  render() {
    ...
    if (showList && total_votes > 0 && active_votes) {
      ...
      avotes.sort(
        (a, b) =>
          Math.abs(parseInt(a.rshares)) > Math.abs(parseInt(b.rshares)) ? -1 : 1
      );
      let voters = [];
      for (
        let v = 0;
...
export default connect(
  ...
  (state, ownProps) => {
    ...
    const enable_slider = net_coining_shares > VOTE_WEIGHT_DROPDOWN_THRESHOLD;
