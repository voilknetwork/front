...
function addSiteMeta(metas) {
    ...
    metas.push({ property: 'og:title', content: 'Voilknetwork| Write Posts and Earn real cash $$$' });
    metas.push({ property: 'og:description', content: site_desc });
    metas.push({
        property: 'og:image',
        content: 'https://graphql.voilk.com/image/4362d5f8f2c1f5d13647fa8e87549adc.png',
    });
...
export default function extractMeta(chain_data, rp) {
    ...
    if (rp.username && rp.slug) {
        ...
        if (content && content.id !== '0.0.0') {
            ...
            const url = 'https://fast.voilk.com' + d.link;
            ...
            metas.push({
                name: 'og:image',
                content: image || 'https://graphql.voilk.com/image/4362d5f8f2c1f5d13647fa8e87549adc.png',
            });
            ...
            metas.push({
                name: 'twitter:image',
                content:
                    image || 'https://graphql.voilk.com/image/4362d5f8f2c1f5d13647fa8e87549adc.png',
            });
        } else {
            addSiteMeta(metas);
        }
        ...
        if (profile_image == null)
            profile_image = 'https://fast.voilk.com/images/voilknetwork-twshare-2.png';
        // Set profile tags
